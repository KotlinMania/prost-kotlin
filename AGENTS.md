...
This file is the quick-reference operating contract for prost-kotlin. The longer
...
prost-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`prost`](https://crates.io/crates/prost). Upstream Rust is the behavioral oracle while the
