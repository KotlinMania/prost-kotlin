...
kotlin {
    ...
    val xcf = XCFramework("Prost")

    macosArm64 {
        binaries.framework { baseName = "Prost"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Prost"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Prost"
        flattenPackage = "io.github.kotlinmania.prost"
    }

    android {
        namespace = "io.github.kotlinmania.prost"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "prost-kotlin", version.toString())

    pom {
        name.set("prost-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/pros - A Protocol Buffers implementation for the Rust Language")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/prost-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/prost-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/prost-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/prost-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleProstXCFramework",
    "assembleProstDebugXCFramework",
    "assembleProstReleaseXCFramework",
    "assembleDebugIosFatFrameworkForProstXCFramework",
    "assembleReleaseIosFatFrameworkForProstXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForProstXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForProstXCFramework",
    "assembleDebugMacosFatFrameworkForProstXCFramework",
    "assembleReleaseMacosFatFrameworkForProstXCFramework",
    "assembleDebugTvosFatFrameworkForProstXCFramework",
    "assembleReleaseTvosFatFrameworkForProstXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForProstXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForProstXCFramework",
    "assembleDebugWatchosFatFrameworkForProstXCFramework",
    "assembleReleaseWatchosFatFrameworkForProstXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForProstXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForProstXCFramework",
